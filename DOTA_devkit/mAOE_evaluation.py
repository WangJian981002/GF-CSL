...
def main():
    detpath = r'./centerRote/result/test96/test96_final/Task1_{:s}.txt'
    annopath = r'./datasets/val/labelTxt/{:s}.txt' # change the directory to the path of val/labelTxt, if you want to do evaluation on the valset
    imagesetfile = r'./datasets/val/val.txt'
