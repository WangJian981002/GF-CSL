...
parser.add_argument('--operation', help='must be one of [visualize,DOTA_test,DOTA_MS_test,HRSC_test]')
...
if __name__ =="__main__":
    if args.operation == 'visualize':
        ...
        print('ERROR OCCUR! --operation must be one of [visualize,DOTA_test,DOTA_MS_test,HRSC_test]')
