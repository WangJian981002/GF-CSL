...
wordname_15 = ['car', 'airplane']


class UCAS_AODSetv1(Dataset):
...
def collater(data):
    ...
    heatmap_t=creat_label_heatmap(imgs,annos,num_classes=2,min_overlap=0.5) #(N,15,H/4,W/4)
    gaussian_smooth=[]
    for anno in annos:
...
if __name__ == "__main__":
    ...
    trainset = UCAS_AODSetv1('../datasets/UCAS_AOD/train')
    print(len(trainset))
